package com.thuvien.repo;

import java.util.Date;

public class QuyenSachRepo {
	private String maQS;
	...
	public QuyenSachRepo() {
	}

	public QuyenSachRepo(String maQS, String tenSach, int daySo, int lanTB, Date ngayTB, int namXB, String tenNXB,
