...
public class NhanVienDao extends QLTVDao<NhanVien, String> {
	...
	public void insert(NhanVien entity) {
		...
		JDBCHelper.executeUpdate(sql, entity.getMaNV(), entity.getTenNV(), entity.getSdt(), entity.getUserName(),
				entity.getPassWord(), entity.isVaiTro(), entity.isTrangThai());
	}
	...
	public NhanVien selectById2(int key) {
		NhanVien nv = new NhanVien();
