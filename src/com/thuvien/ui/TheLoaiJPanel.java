...
public class TheLoaiJPanel extends JPanel {
	...
	public TheLoaiJPanel() {
		...
		btnPrevList.setBounds(833, 491, 85, 21);
		add(btnPrevList);
		...
		lblIndexTrang.setBounds(973, 495, 39, 13);
		add(lblIndexTrang);

		JButton btnNewButton = new JButton("Xem Chi Tiết");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				TheLoaiChiTietJPanel tacGiaChiTietJPanel = new TheLoaiChiTietJPanel();
				Container container = TheLoaiJPanel.this.getParent();
				container.remove(TheLoaiJPanel.this);
				container.add(tacGiaChiTietJPanel);
				container.revalidate();
				container.repaint();
			}
		});
		btnNewButton.setBounds(654, 491, 152, 21);
		add(btnNewButton);
